...
<body>
  ...
  <p>It has been <b>{{Carbon\Carbon::now()->diffInDays(Carbon\Carbon::parse($borrowing->from_date))}}</b> days since you borrowed the book <strong>{{$borrowing->books->name}}</strong>,
