      ...
      <div class="col-md-3">
        ...
        <div class="box box-primary">
          <div class="box-body box-profile">
            ...
            <h3 class="profile-username text-center">{{ $user->name }}</h3> <center><a href=""><small>({{ __('detailsuser.edit_profile') }})</small></a></center>
            <p class="text-muted text-center">
              @if ($user->role == 1) {{ __('detailsuser.admin') }}
              @else {{ __('detailsuser.member') }}
              @endif
            </p>
      ...
      <div class="col-md-9">
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <hr>
            {{ __('detailsuser.joined_date') }}: <em>{{ $user->created_at }}</em>
            <hr>
